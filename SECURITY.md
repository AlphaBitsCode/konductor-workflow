...
The Konductor AI Workflow is strictly built on **self-contained, self-host practices**. We believe that your enterprise workflow, coding constraints, and architecture decisions should be tightly governed by you.

- **Data Stays Local:** All framework-generated data, including your project roadmap, memory files, and check-in scratchpads, are stored exclusively on your local machine.
...
At this time, framework data resides as plain Markdown on your local drive to ensure ease of reading for IDE assistants.
