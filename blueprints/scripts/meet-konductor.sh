...
FILE_MAPPINGS=(
  ...
  "blueprints/docs/AGENT_BEHAVIOR.md:docs/AGENT_BEHAVIOR.md"
...
echo "  4. Review docs/AGENT_BEHAVIOR.md"
echo "  5. Review .konductor/memory/KONDUCTOR_MEMORY.md"
echo "  6. Use .konductor/memory/KONDUCTOR_MEMORY.md for long-term memory"
echo "  7. Use .konductor/memory/KONDUCTOR_ADR_HISTORY.md for critical architectural decisions"
echo "  8. First-time setup: copy & paste this into your AI assistant:"
