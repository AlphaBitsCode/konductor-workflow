...
<konductor_contract>
  <framework_version>0.2.9</framework_version>
  <system>
  ...
  <rules>
    ...
    <rule priority="4">Document routing: Only `README.md` and `KONDUCTOR.md` at repo root. Everything else in `docs/` or `.konductor/`. Note: `KONDUCTOR.md`, `.konductor/KONDUCTOR_WORKFLOW.md`, and `docs/KONDUCTOR_GUIDE.md` will be overwritten by upstream updates.</rule>
